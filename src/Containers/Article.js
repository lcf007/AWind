  ...
  render() {
    return (
      <div className="row">
        ...
        <div className="card col-8 mt-4" onClick={this.clickCard.bind(this)}>
          {this.props.obj.multimedia.length > 0 && <img className="card-img-top" src={this.props.obj.multimedia[this.props.obj.multimedia.length-1].url} alt="Card image cap" /> }
